...
感谢您对**备忘清单**贡献的兴趣👍👍，是像您这样的人使 [`Quick Reference`](https://jackconfeng.github.io/reference) 成为如此出色的网站 🎉🎉。随时提交问题和增强请求，还提供一个[在线说明排版说明]( https://wangchujiang.com/reference/docs/quickreference.html)，所以各种使用技巧，都在这个排版说明中有预览和实现代码。
...
只需要 `标题<h1>` 和 `介绍` (标题下面)。脚本会自动识别，通过 GitHub Actions 自动发布 [`Quick Reference`](https://jackconfeng.github.io/reference) 网站。
...
[`Quick Reference`](https://jackconfeng.github.io/reference) 使用 [`@wcj/markdown-to-html`](https://github.com/jackconfeng/markdown-to-html) 转换 `Markdown`，并使用 [`rehype-attr`](https://github.com/jackconfeng/rehype-attr) 插件让其支持通过其注释语法添加类和样式。此外，您可以在 Quick Reference 备忘清单上使用样式参考：<https://jackconfeng.github.io/reference/docs/quickreference.html>

最后，参考现有备忘清单的源代码是一个好习惯！

## 首页导航

[`Quick Reference`](https://jackconfeng.github.io/reference) 的首页存放在仓库的根目录 `README.md`，[`Quick Reference`](https://jackconfeng.github.io/reference) 是通过这个 `README.md` 自动生成首页导航，下面是导航实例：
...
- 图标存放在 [`scripts/assets`](https://github.com/jackconfeng/reference/blob/main/scripts/assets) 目录中
...
```bash
$ git clone https://github.com/jackconfeng/reference.git 
$ npm i          # 安装依赖
...
```shell
$ git clone https://github.com/jackconfeng/reference.git -b gh-pages
```
...
DATA_DIR="/data"
REPO_URL="https://gitee.com/jackconfeng/reference.git"
BRANCH="gh-pages"
MAX_BACKUPS=3
...
在仓库添加 `.github/workflows/update-ref.yml` 文件 Github Actions 配置，感谢 @eryajf https://github.com/jackconfeng/reference/issues/102#issuecomment-1368158419 提供方法
  ...
  build: # 自定义名称
    ...
    steps:
      - name: 🚜 拉取最新代码
        ...
        with:
          ref: 'main'
          repository: 'jackconfeng/reference'
...
<!--GAMFC--><a href="https://github.com/jackconfeng" title="小弟调调"><img src="https://avatars.githubusercontent.com/u/1680273?v=4" width="42;" alt="小弟调调"/></a>
...
上图贡献者列表，由 [contributors](https://github.com/jackconfeng/github-action-contributors) 自动生成贡献者图片。

## License

MIT © [Kenny Wong](https://github.com/jackconfeng)
