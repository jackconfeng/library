...
`author:jackconfeng` | 作者 <pur>`jackconfeng`</pur> 打开
`mentions:jackconfeng` | 提及 <pur>`jackconfeng`</pur> 用户
`assignee:jackconfeng` | 分配给 <pur>`jackconfeng`</pur> 用户
...
:-- | --
:-- | --
`fullname:jackconfeng` | 全名 <pur>jackconfeng</pur>
