...
- [Regex syntax](./regex.md) _(jackconfeng.github.io)_
- [Regex examples](./regex.md#正则表达式示例) _(jackconfeng.github.io)_
...
- [grep 中文文档](https://wangchujiang.com/linux-command/c/grep.html) _(jackconfeng.github.io)_
