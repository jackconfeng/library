...
这是您可以在 Quick Reference 备忘单上使用的样式参考，快速参与[贡献](https://github.com/jackconfeng/reference/blob/main/CONTRIBUTING.md)！
...
将仓库克隆到本地调试页面。请参阅[贡献指南](https://github.com/jackconfeng/reference/blob/main/CONTRIBUTING.md)了解如何开始

#### 克隆仓库

```shell
git clone git@github.com:jackconfeng/reference.git
```
...
[鼠标移动到上面有提示](https://github.com/jackconfeng/reference) _Tooltips 的提示内容_<!--rehype:tooltips-->
